namespace DataGenerator
{
    ...
    public class CreateUsersData
    {
        ...
        public static List<User> CreateData()
        {
            ...
            {
                users.Add(new User(start.AddDays(random.Next(range)), Convert.ToBoolean(random.Next(2)), maxLastVisit.AddDays(random.Next(range2)), names[random.Next(names.Count)], Convert.ToBoolean(random.Next(2)), i));
            }
